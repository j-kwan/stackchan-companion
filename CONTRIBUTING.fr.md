...
## Les neuf portails, et ce que chacun vous dira
...
| `check-rules` | un fichier de règles de la carte contient une ligne que le parseur jetterait, une règle qui part toute seule, un seuil jamais atteignable, ou plus de règles que le moteur n'en garde |
...
`test/test_*/` tient les suites natives — 37 suites, pour 429 cas. Tout ce qui est
